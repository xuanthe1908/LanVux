        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Quality education at your fingertips, anytime, anywhere.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/courses?category=mobile-development" className="text-gray-400 hover:text-white">Mobile Development</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>Education City, 12345</li>
              <li>Email: info@e-learning.com</li>
